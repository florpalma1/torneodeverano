...
export const Banner = () => {
  ...
  const toRotate = [ "Edicion 2025", "algo", "algo" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Torneo de Verano`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Edicion 2025", "algo", "algo" ]'><span className="wrap">{text}</span></span></h1>
